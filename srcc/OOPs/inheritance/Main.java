...
//        but you can't  access the elements which aren't initialized in the parent constructor
        ...
        /* there are many variables in both parent and child classes you are given access to variables that are in the ref type i.e. box_weight
        hence you should have access to weight variable . This also means that the ones you are truing to access it should be initialized but here
        when the obj itself
